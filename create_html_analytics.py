# coding=utf-8
import monthly_visits, monthly_downloads,top_25, dep_or_agency, datasets_released_by_month, intro,down_files,remove_csv_files, os, datetime, yaml
...
def main():
    ...
    final_html_en()
    final_html_fr()
    remove_csv_files.csv_files_remove()
